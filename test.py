...
def update_display_and_color():
    """Atualiza a label e muda a cor se múltiplo de 10 (exceto 0)."""
    value = get_value()
...
button_reset = ttk.Button(frame, text='Reset', command=on_reset)
